...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Alkhalilarabic`}</title>

        <meta
          name="description"
          content="Welcome to Alkhalilarabic - Your Gateway to Mastering the Arabic Language Online in a Short Span of Time."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1544685584-9d18c3420eb4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBcmFiaWMlMjBsYW5ndWFnZXxlbnwwfHx8fDE2OTE3NTQwMDh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@syhussaini?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Syed Hussaini`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Alkhalilarabic - Your Gateway to Mastering the Arabic Language Online in a Short Span of Time.`}
            </Text>
            <Box
